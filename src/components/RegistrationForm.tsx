...
const FORM_STEPS = [
  { id: 'insurance', title: 'Insurance Information & Photo Upload', component: InsuranceSection },
          ...
          <div className="space-y-4">
            <div className="bg-white p-4 rounded-lg border border-blue-200">
              <h3 className="font-semibold text-blue-800 mb-2 flex items-center">
                ...
                Option 1: Upload Insurance Card Photos (Recommended)
              </h3>
              <p className="text-gray-700 text-sm">
                Take photos of your insurance cards using your phone camera. Our system will automatically extract the information to pre-fill the form fields below.
              </p>
            </div>
            <div className="bg-white p-4 rounded-lg border border-blue-200">
              <h3 className="font-semibold text-blue-800 mb-2 flex items-center">
              ...
              <p className="text-gray-700 text-sm">
                If you don't have your insurance cards available, you can skip the photo upload and manually enter all information in the form fields below.
              </p>
            </div>
          </div>
        </div>
