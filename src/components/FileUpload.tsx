...
export function FileUpload({
  ...
  const handleCameraClick = () => {
    ...
    if (isMobile) {
      ...
      // On desktop, just open file picker with camera preference
      fileInputRef.current?.click();
    }
  };
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col space-y-2">
              ...
              >
                ...
                <span>{/Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? 'Take Photo' : 'Camera/Photo'}</span>
              </button>
              <button
                type="button"
                onClick={(e) => {
